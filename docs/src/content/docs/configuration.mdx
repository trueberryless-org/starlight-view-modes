...
We recommend enabling this option of you want to give your users the opportunity to search whilst in Zen mode.
...
:::note
We don't recommend using the shortcut `Ctrl+K` because it is already used opening the search modal.
:::
