...
The content of deeper headings stays on the slide of their section when it fits, and otherwise continues on slides placed vertically below the section.
...
<SpeakerNotes>
  ...
  options of each setting when available.
</SpeakerNotes>
