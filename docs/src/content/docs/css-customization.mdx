...
Any custom unlayered CSS will override the default styles from the `starlight`, `zen-mode`, and `presentation-mode` layers.
...
```css "starlight" "zen-mode" "presentation-mode"
