...
import { type StarlightViewModesConfig, validateConfig, type StarlightViewModesUserConfig } from "./libs/config";
...
export default function starlightViewModes(userConfig?: StarlightViewModesUserConfig): StarlightPlugin {
